...
export function Header() {
  return (
    <header className="max-w-[1440px] h-[72px] bg-white">
      <nav className="w-full h-full p-3 flex items-center justify-between">
        <div className="flex items-center justify-center">
          ...
          <a href="#" className="mr-6">
            <Image src={logoImg} alt="logo image" width={127} height={51} />
          </a>
        ...
        <div className="flex items-center justify-center">
          ...
          <button className="w-[168px] h-[50px] ml-[112px] flex items-center justify-start rounded-md p-3 bg-[#45c777]">
          ...
          <button className="w-[134px] h-9 flex items-center justify-between p-2 bg-white border-2 border-[#788693] rounded-md ml-2">
